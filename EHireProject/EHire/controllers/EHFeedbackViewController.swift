    ...
    @IBAction func subRound(sender: AnyObject)
    {
        ...
        switch self.subRound.selectedSegment
        {
            ...
            case 1:
                ...
                if selectedCandidate?.interviewedByManagers?.count > self.subRound.selectedSegment
                {
                    let allObjects = selectedCandidate?.interviewedByManagers?.allObjects
                    let isCandidaterRejected =   managerFeedback?.sortArray(allObjects!, index:self.subRound.selectedSegment)
                ...
                else  if selectedCandidate?.interviewedByManagers?.count == 0
                {
